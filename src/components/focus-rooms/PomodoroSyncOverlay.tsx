...
export const PomodoroSyncOverlay: React.FC<PomodoroSyncOverlayProps> = ({
  ...
  return (
    <div className="flex flex-col gap-2 p-2.5 px-3 rounded-2xl bg-card/90 border border-border/80 backdrop-blur-xl shadow-md">
      ...
      <div className="flex items-center justify-between flex-wrap gap-2">
        ...
        <div className="flex items-center gap-2">
          ...
          >
            {mode === "work" ? <Flame className="w-3.5 h-3.5 fill-primary" /> : <Coffee className="w-3.5 h-3.5" />}
          </div>
          <div>
            <div className="flex items-center gap-1.5">
              <span className="text-[11px] font-mono font-extrabold uppercase text-foreground">
            ...
            <span className="text-[9.5px] text-muted-foreground font-medium flex items-center gap-1">
              <Clock className="w-2.5 h-2.5 text-primary" />
              <span>Synced live across squad</span>
            </span>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2">
          <div className="font-mono text-xl sm:text-2xl font-black text-foreground tracking-wider bg-surface/80 px-2.5 py-0.5 rounded-xl border border-border/60 shadow-inner">
            {formattedTime}
          </div>
          ...
          <div className="flex items-center gap-1">
            {isRunning ? (
              <button
                ...
                className="p-2 rounded-xl bg-surface border border-border/80 hover:bg-muted text-foreground transition-all cursor-pointer shadow-xs"
              >
              ...
              <button
                ...
                className="p-2 rounded-xl bg-primary text-primary-foreground hover:bg-primary/90 transition-all cursor-pointer shadow-md flex items-center gap-1"
              >
            ...
            <button
              ...
              className="p-2 rounded-xl bg-surface border border-border/80 hover:bg-muted text-muted-foreground hover:text-foreground transition-all cursor-pointer shadow-xs"
            >
