              ...
              {tab !== "forgot" && (
                <>
                  ...
                  <button
                    ...
                    className="w-full py-3 rounded-xl border border-border bg-surface text-foreground text-[13px] cursor-pointer hover:border-primary/50 hover:bg-surface transition-all mb-2.5 font-semibold flex items-center justify-center gap-2"
                  >
